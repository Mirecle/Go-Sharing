...
from train_decode import train
...
def main():
    ...
    command='continue'
    folder='.\\runs\\first_no_noise 2022.01.06--22-58-48\\' #指定无噪声训练好的模型
    priv_folder='.\\runs\\decode_test 2022.01.17--21-41-04\\'
    ...
    if command == 'continue':
        ...
        utils.model_from_checkpoint_only_decode(model, checkpoint)
